...
int             main()
{
    ...
    printf("> ft_strncpy(buffer, \"Foo\", 4);\n\n");
    ...
    print_buffer(ft_strncpy(buffer, "Foo", 4));
    init_buffer(buffer);
    printf("\nNow let's try setting the copy size LARGER than\n");
    printf("the size of the src string.\n\n");
    printf("> ft_strncpy(buffer, \"Foo\", 25);\n\n");
    print_buffer(ft_strncpy(buffer, "Foo", 25));
    init_buffer(buffer);
    ...
    printf("> ft_strncpy(buffer, \"Foo Bar\", 4);\n\n");
    print_buffer(ft_strncpy(buffer, "Foo Bar", 4));
